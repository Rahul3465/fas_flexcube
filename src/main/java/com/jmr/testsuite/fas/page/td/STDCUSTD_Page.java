package com.jmr.testsuite.fas.page.td;
...
public class STDCUSTD_Page
{
	...
	@SheetColumn("PayinChequeInstrumentNo")
	private String payinChequeInstrumentNo;
	@SheetColumn("PayinClearingType")
	private String payinClearingType;
	@SheetColumn("PayinChequeDate")
	private String payinChequeDate;
	@SheetColumn("PayinDraweeAccountNumber")
	private String payinDraweeAccountNumber;
	@SheetColumn("PayinRoutingNo")
	private String payinRoutingNo;
	@SheetColumn("PayoutType")
	private String payoutType;
	@SheetColumn("PayoutPercentage")
	...
	@SheetColumn("InterestBookingAccount")
	...
	public String toString() {
		return "STDCUSTD_Page [testCaseResult=" + testCaseResult + ", testCaseId=" + testCaseId
				+ ", termDepositCurrency=" + termDepositCurrency + ", customerNo=" + customerNo + ", runmode=" + runmode
