...
import com.jmr.testsuite.fas.page.BookStoreage_7551Page;
...
public class BookStoreage_7551Test  extends AbstractTestNGSpringContextTests{
	...
	private final String screenName = "Book Shortage : Branch Date*.";
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = xlsReader.read(BookStoreage_7551Page.class, new File(AppConfig.testFileLocation), 19);
