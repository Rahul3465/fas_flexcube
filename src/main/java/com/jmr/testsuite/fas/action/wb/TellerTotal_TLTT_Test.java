...
import com.jmr.testsuite.fas.page.TellerTotal_TLTT_Page;
...
public class TellerTotal_TLTT_Test extends AbstractTestNGSpringContextTests{
	...
	private final String screenName = "Teller Totals : Branch Date*.";
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = xlsReader.read(TellerTotal_TLTT_Page.class, new File(AppConfig.testFileLocation), 17);
