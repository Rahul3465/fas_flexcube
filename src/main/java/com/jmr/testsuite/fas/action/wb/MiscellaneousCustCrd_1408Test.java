...
import com.jmr.testsuite.fas.page.MiscellaneousCustCrd_1408Page;
...
public class MiscellaneousCustCrd_1408Test  extends AbstractTestNGSpringContextTests {
	...
	private final String screenName = "Miscellaneous Customer Credit : Branch Date.*";
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = xlsReader.read(MiscellaneousCustCrd_1408Page.class, new File(AppConfig.testFileLocation), 9);
