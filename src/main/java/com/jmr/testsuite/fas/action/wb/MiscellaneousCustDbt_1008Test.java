...
import com.jmr.testsuite.fas.page.MiscellaneousCustDbt_1008Page;
...
public class MiscellaneousCustDbt_1008Test extends AbstractTestNGSpringContextTests{
	...
	private final String screenName = "Miscellaneous Customer Debit : Branch Date*.";
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = xlsReader.read(MiscellaneousCustDbt_1008Page.class, new File(AppConfig.testFileLocation), 10);
