...
import com.jmr.testsuite.fas.page.TransferCashFromVault_9007_Page;
...
public class TransferCashFromVault_9007_Test  extends AbstractTestNGSpringContextTests{
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = xlsReader.read(TransferCashFromVault_9007_Page.class, new File(AppConfig.testFileLocation), 24);
