...
import com.jmr.testsuite.fas.page.TillBalancingClouser_TVCL_Page;
...
public class TillBalancingClouser_TVCL_Test extends AbstractTestNGSpringContextTests {
	...
	public void initSetup() throws Exception {
		...
		fcubs.launchApp();
		dataList1 = xlsReader.read(TillBalancingClouser_TVCL_Page.class, new File(AppConfig.testFileLocation), 15);
